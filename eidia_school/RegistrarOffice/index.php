...
<?php 
//represents the home page for users with the role 'Registrar Office.'
session_start();
// Check if the user is logged in and has the role set
if (isset($_SESSION['r_user_id']) && 
    isset($_SESSION['role'])) {
      // Check if the user has the role of 'Registrar Office'
...
<body>
    ...
    <!--It includes Bootstrap and jQuery libraries for styling and functionality.-->
