...
//checks if the necessary POST parameters are set, indicating that the form has been submitted.
if (isset($_POST['fname']) && isset($_POST['lname']) && isset($_POST['username']) &&
    ...
    //retrieves form data from the POST parameters 
    $fname = $_POST['fname'];
    $lname = $_POST['lname'];
    ...
    //check if one of the places is empty and show where's the error
    if (empty($fname)) {
