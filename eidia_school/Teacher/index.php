         ...
         <div class="card" style="width: 22rem;">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">Subject: 
                <?php 
                   $s = ''; // Initializes an empty string variable $s to store the subjects.
                   /*Converts the subjects stored in the $teacher['subjects']
                    variable into an array of characters using str_split. 
