<?php 
//page qui permet d'afficher les courses 
session_start();
                  ...
                  <tbody>
                    <?php  foreach ($courses as $course ) { ?>
                      <tr>
                        ...
                        <td>
                          <a href="course-edit.php?course_id=<?=$course['subject_id']?>" class="btn btn-warning">
                            Edit
                          </a>
                              
                          <a href="course-delete.php?course_id=<?=$course['subject_id']?>" class="btn btn-danger">
                            Delete
                          </a>
                        </td>
