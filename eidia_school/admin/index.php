<?php 
//la page dédié pour l'admin : il permet de gérer les étudiant, les prof, registrarçoffice ansi des grades courses and classes 
session_start();
  ...
  <div class="container mt-5 ">
    <div class="container text-center ">
      <div class="row row-cols-5 ">
        <a href="teacher.php" class="col btn btn-dark m-2 py-4">
        ...
        <a href="registrar-office.php" class="col btn btn-dark m-2 py-4">
          <i class="fa fa-pencil-square fs-1" aria-hidden="true"></i><br>
          Registrar Office
        </a> 
               
        <a href="class.php" class="col btn btn-dark m-2 py-4">
        ...
        <a href="grade.php" class="col btn btn-dark m-2 py-4">
