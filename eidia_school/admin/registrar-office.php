<?php 
//l'affichage de tout les registrar_office pour l'admin 
session_start();
      ...
      <table class="table table-bordered mt-3 n-table">
        ...
        <tbody>
          ...
          <tr>
              ...
              <td>
                <a href="registrar-office-edit.php?r_user_id=<?=$r_user['r_user_id']?>"class="btn btn-warning">
                  Edit
                </a>
